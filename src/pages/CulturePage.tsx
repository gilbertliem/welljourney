...
import { Coffee, Sparkles, Utensils, Home, Music, Clock, MapPin, ArrowRight, Award, Compass } from 'lucide-react';
import { CULTURE_ELEMENTS, DAILY_RHYTHM } from '../data/cultureData';
...
export const CulturePage: React.FC<CulturePageProps> = ({
  ...
  const [selectedRhythm, setSelectedRhythm] = useState<string>('morning');
  ...
  return (
    <div className="bg-[#FDFBF7]">
      ...
      <section className="relative pt-24 lg:pt-0 lg:min-h-screen flex items-center overflow-hidden bg-[#1F422F]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col lg:w-3/4">
          ...
          <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-white leading-tight mb-6 font-bold">
            We Don't Arrange Tourist Attractions. <br />
            <span className="text-[#D4A359]">We Give You Days to Just Breathe.</span>
          </h1>

          <p className="text-base sm:text-xl text-[#FDFBF7]/85 mb-10 max-w-2xl leading-relaxed font-light">
            Experience Quanzhou not as a hurried visitor, but through the restorative rhythm of authentic local living, fragrant Tieguanyin tea, and soothing ancient soundscapes.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl text-[#222222] font-bold mb-4">
              The 5 Elements of Quanzhou Daily Healing
            </h2>
            <div className="w-16 h-1 bg-[#D4A359] mx-auto"></div>
          </div>

          <div className="space-y-24">
            {CULTURE_ELEMENTS.map((el, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full lg:w-1/2 ${isEven ? 'lg:pl-8' : 'lg:pr-8'}`}>
                    ...
                    <h3 className="font-serif text-2xl sm:text-3xl text-[#222222] font-bold mb-1">
                      {el.title}
                    </h3>
                    <p className="text-base text-[#C87D55] font-serif mb-4">{el.titleZh}</p>
                    ...
                    <button
                      ...
                      className="inline-flex items-center text-xs font-semibold text-[#2C5E43] hover:text-[#3A7856] group/btn"
                    >
                      <span>Incorporate this into your itinerary</span>
      ...
      {/* SECTION 3: "A DAY IN THE LIFE" (Visual Rhythm Timeline) */}
          ...
          <div className="bg-[#2C5E43] text-white rounded-3xl overflow-hidden shadow-xl flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-10 sm:p-16 flex flex-col justify-center">
              <span className="text-xs font-semibold text-[#D4A359] uppercase tracking-wider block mb-2">
                Spiritual Heritage & Tranquility
              </span>
              ...
              <div className="space-y-4">
                <div className="flex items-center bg-white/10 p-4 rounded-xl border border-white/15">
                  ...
                  <div>
                    <span className="font-semibold text-white block text-sm">UNESCO World Heritage City</span>
                    <span className="text-xs text-white/70">Song-Yuan Maritime Emporium</span>
                  </div>
                </div>
                ...
                <div className="flex items-center bg-white/10 p-4 rounded-xl border border-white/15">
                  ...
                  <div>
                    <span className="font-semibold text-white block text-sm">Cradle of Minnan Culture & Tea Heritage</span>
                    <span className="text-xs text-white/70">Authentic Tieguanyin & Wuyi Oolong origins</span>
                  </div>
                </div>
                ...
                <div className="flex items-center bg-white/10 p-4 rounded-xl border border-white/15">
                  ...
                  <div>
                    <span className="font-semibold text-white block text-sm">High-Trust, Welcoming Community</span>
                    <span className="text-xs text-white/70">A peaceful spiritual sanctuary with 1000-year temples</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white border border-[#F5F0EB] p-8 sm:p-12 rounded-3xl shadow-soft">
            <h3 className="font-serif text-2xl sm:text-3xl text-[#222222] font-bold mb-4">
              How these experiences are woven into your stay
            </h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                onClick={() => onNavigate('packages')}
                className="px-6 py-3.5 bg-[#2C5E43] hover:bg-[#3A7856] text-white font-medium rounded-xl transition-all shadow-sm"
              >
                View 3-Day & 5-Day Packages
              </button>
              <button
                onClick={onOpenConsultation}
                className="px-6 py-3.5 border border-[#C87D55] text-[#C87D55] font-medium rounded-xl hover:bg-[#C87D55]/10 transition-all"
              >
                Customize Your Cultural Rhythm
              </button>
            </div>
          </div>
        </div>
